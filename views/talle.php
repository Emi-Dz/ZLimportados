...
<html lang="es">
  ...
  <body>
    <main>
      ...
      <section class="header">
        ...
        <div class="talles">
          <select name="selector_talles" id="selector_talles" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
            <option value="talles"><?php echo $_GET['valor']; ?></option>
            <option value="talle.php?talle=36&valor=36">36</option>
            <option value="talle.php?talle=37&valor=37">37</option>
            <option value="talle.php?talle=38&valor=38">38</option>
            <option value="talle.php?talle=39&valor=39">39</option>
            <option value="talle.php?talle=40&valor=40">40</option>
            <option value="talle.php?talle=41&valor=41">41</option>
            <option value="talle.php?talle=42&valor=42">42</option>
            <option value="talle.php?talle=43&valor=43">43</option>
            <option value="../index.php">TODOS</option>
          </select>
        </div>
        <div class="link-talles">
        <h3>Talles</h3>
        <a href="talle.php?talle=36">36</a>
        <a href="talle.php?talle=37">37</a>
        <a href="talle.php?talle=38">38</a>
        <a href="talle.php?talle=39">39</a>
        <a href="talle.php?talle=40">40</a>
        <a href="talle.php?talle=41">41</a>
        <a href="talle.php?talle=42">42</a>
        <a href="talle.php?talle=43">43</a>
      ...
      $talle = $_GET["talle"];
      $consulta="SELECT * FROM zapas WHERE talle=$talle";
      ...
      while ($reg = mysqli_fetch_array($datos)) {?>
          ...
          <div class="container-zapas">
            <a href="producto.php?id=<?php echo $reg['id'];?>">
              <img
                id="zapas"
